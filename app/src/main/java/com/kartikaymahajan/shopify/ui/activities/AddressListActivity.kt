...
import com.kartikaymahajan.shopify.databinding.ActivityAddressListBinding
import com.kartikaymahajan.shopify.firestore.FirestoreClass
import com.kartikaymahajan.shopify.models.Address
import com.kartikaymahajan.shopify.ui.adapters.AddressListAdapter
import com.kartikaymahajan.shopify.utils.Constants
import com.kartikaymahajan.shopify.utils.SwipeToDeleteCallback
import com.kartikaymahajan.shopify.utils.SwipeToEditCallback
...
class AddressListActivity : BaseActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        if (mSelectAddress) {
            mBinding.tvTitle.text = resources.getString(R.string.title_select_address)
        }
    ...
    private fun setupActionBar() {
        ...
        mBinding.toolbarAddressListActivity.setNavigationOnClickListener { onBackPressed() }
    }
    ...
    fun successAddressListFromFirestore(addressList: ArrayList<Address>) {
        ...
        if (addressList.size > 0) {
            ...
            mBinding.rvAddressList.layoutManager = LinearLayoutManager(this@AddressListActivity)
            ...
            if (!mSelectAddress) {
                ...
                editItemTouchHelper.attachToRecyclerView(mBinding.rvAddressList)
                ...
                deleteItemTouchHelper.attachToRecyclerView(mBinding.rvAddressList)
            }
        } else {
